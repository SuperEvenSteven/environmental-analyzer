...
/**
 * Represents the GSOD data model.
 * 
 * @author Stephen O'Hair
 *
 */
@ThreadSafe
public final class GSODDataModel {
     ...
     *            object builder
     */
    public GSODDataModel(ModelBuilder builder) {
    ...
    /**
     * @return csv representation of a {@link GSODDataModel}
     */
    public String toCsv() {
    ...
    public static class ModelBuilder {
         ...
         * Builder build.
         * 
         * @return {@link GSODDataModel}
         */
        public GSODDataModel build() {
            return (new GSODDataModel(this));
        }
    }
}
